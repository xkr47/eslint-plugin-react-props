  ...
  function assertExpectedReactPropSyntax(key, declaration, allowIsRequired) {
    ...
    if (declaration.type === 'CallExpression') {
      ...
      switch (propValue) {
        ...
        default: return context.report(declaration, "property '" + key + "': " + propType + ' must be called like a function');
      }
      if (declaration.arguments.length !== 1) {
        context.report(declaration, "property '" + key + "': " + propType + ' expects exactly one argument of type ' + argType[propValue]);
      }
